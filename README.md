...
If the first pixel pass detects no reading, a horizontal background estimate reduces interference from LCD borders and shadows, with a separate pass for closely spaced rows and smaller pulse digits. This retry cannot override an uncertain first pass and still requires agreement across multiple contrast levels.
